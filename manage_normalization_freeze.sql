...
GO
/****** Object:  StoredProcedure [dbo].[manage_normalization_freeze]    Script Date: 07/25/2014 10:40:06 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[manage_normalization_freeze] (@norm_freeze_period BIGINT)
 ...
 IF(@last_norm_id=0)
    ...
    SELECT @norm_end_time AS END_TIME, MAX(norm_end_time) FROM normalization_history
