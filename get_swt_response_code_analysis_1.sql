select ds.sink_node_name,ds.source_node_name,ds.rsp_code_rsp,dbo.formatRspCodeStr(ds.rsp_code_rsp) as rsp_code_description, COUNT(*)as count_nr, tcount_tab.tr_count as total,  CONVERT(FLOAT, COUNT(*))/CONVERT(FLOAT,tcount_tab.tr_count) *100.0000000000 AS 'percentage (%)'
...
SELECT (CONVERT(FLOAT,16)/CONVERT(FLOAT,145832)) 