...
ALTER PROCEDURE osp_normalization_resolve_tran_link
	@tran_nr							BIGINT,
...
IF (LEFT(@last_source_msg_type,2)  NOT IN ('01','02','04'))
		BEGIN
		...
		IF  (@last_source_rsp_code_rsp  IN ('00','08','10','16','11'))
		BEGIN
...
IF (LEFT(@last_sink_msg_type,2)  NOT IN ('01','02','04'))
		BEGIN
...
IF  (@last_sink_rsp_code_rsp IN('00','08','10','16','11'))
		BEGIN
