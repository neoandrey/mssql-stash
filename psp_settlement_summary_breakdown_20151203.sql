...
WHEN PTT.Retention_data = '1046' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE') 
						 THEN 'UBN'
WHEN PTT.Retention_data ='9130' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'ABS'
WHEN PTT.Retention_data ='9044' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'ABP'
WHEN PTT.Retention_data ='9023'  and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'CITI'
WHEN PTT.Retention_data ='9050' and 
                        (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'EBN'
WHEN PTT.Retention_data ='9214' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'FCMB'
WHEN PTT.Retention_data ='9070' and 
						(RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'FBP'
...
WHEN PTT.Retention_data ='9058'  and 
                        (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'GTB'
WHEN PTT.Retention_data ='9082' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'KSB'
WHEN PTT.Retention_data ='9076' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'SKYE'
WHEN PTT.Retention_data ='9084' and 
                       (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'ENT'
WHEN PTT.Retention_data ='9039' and 
						(RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'IBTC'
WHEN PTT.Retention_data ='9068' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'SCB'
WHEN PTT.Retention_data ='9232' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'SBP'
WHEN PTT.Retention_data ='9032'  and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'UBN'
WHEN PTT.Retention_data ='9033'  and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'UBA'
WHEN PTT.Retention_data ='9215'  and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')  then 'UBP'
WHEN PTT.Retention_data ='9035' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'WEMA'
WHEN PTT.Retention_data ='9057' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'ZIB'
WHEN PTT.Retention_data ='9301' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   then 'JBP'
...
WHEN PTT.Retention_data = '1708' and 
                         (RIGHT(DebitAccNr.acc_nr,18) = 'ISSUER_FEE_PAYABLE'  OR RIGHT(DebitAccNr.acc_nr,21) = 'ISSUER_FEE_RECEIVABLE' OR RIGHT(DebitAccNr.acc_nr,14) = 'AMOUNT_PAYABLE'
						 OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_PAYABLE' OR CreditAccNr.acc_nr LIKE '%ISSUER_FEE_RECEIVABLE'  OR CreditAccNr.acc_nr LIKE '%AMOUNT_PAYABLE')   THEN 'FBN'
...
WHEN PTT.Retention_data = '1034' and 
                         ...
                         WHEN (LEFT(DebitAccNr.acc_nr,3) =  '3LCM' OR LEFT(CreditAccNr.acc_nr,3) =  '3LCM') THEN '3LCM'
...
END,
	trxn_category=CASE WHEN (PT.tran_type ='01'  AND (SUBSTRING(PTC.Terminal_id,1,1) IN ('1','0'))) 
                           ...
                           WHEN (PT.tran_type ='01'  AND (SUBSTRING(PTC.Terminal_id,1,1) IN ('1','0'))) 
			   ...
			   WHEN (dbo.fn_rpt_isBillpayment (PTC.terminal_id,PT.extended_tran_type,PT.message_type,PT.sink_node_name,PT.payee,ptc.card_acceptor_id_code ,ptc.source_node_name,pt.tran_type,ptc.pan) = '1') then 'BILLPAYMENT'
                           ...
                           WHEN (PT.tran_type ='40'  AND ((SUBSTRING(PTC.Terminal_id,1,1) IN ('0','1','4')))) THEN 'CARD HOLDER ACCOUNT TRANSFER'
                           ...
                           SUBSTRING(PTC.Terminal_id,1,1) in ( '2','5','6')
                           and (RIGHT(CreditAccNr.acc_nr,19)='PTSP_FEE_RECEIVABLE'  or  RIGHT(DebitAccNr.acc_nr,19)='PTSP_FEE_RECEIVABLE')) 
...
END,
  Debit_account_type=CASE 
	                  ...
	                  WHEN (DebitAccNr.acc_nr LIKE '%AMOUNT%RECEIVABLE') THEN 'AMOUNT RECEIVABLE(Debit_Nr)'
                          ...
                          WHEN ( RIGHT(DebitAccNr.acc_nr,32) = 'PAYIN_INSTITUTION_FEE_RECEIVABLE') THEN 'PAYIN INSTITUTION FEE RECEIVABLE(Debit_Nr)'
                          WHEN (DebitAccNr.acc_nr LIKE '%ISW%FEE%PAYABLE') THEN 'ISW FEE PAYABLE(Debit_Nr)'
                          WHEN ( CHARINDEX('ISW_ATM_FEE_CARD_SCHEME',DebitAccNr.acc_nr)>0) THEN 'ISW CARD SCHEME FEE RECEIVABLE (Debit_Nr)'
                          WHEN ( CHARINDEX( 'ISW_ATM_FEE_ACQ_', DebitAccNr.acc_nr) > 0 ) THEN 'ISW ACQUIRER FEE RECEIVABLE (Debit_Nr)'
                          WHEN ( CHARINDEX( 'ISW_ATM_FEE_ISS_',DebitAccNr.acc_nr)>0  ) THEN 'ISW ISSUER FEE RECEIVABLE (Debit_Nr)'
                          ...
                          WHEN ( LEFT(DebitAccNr.acc_nr,15) = 'POS_FOODCONCEPT')THEN 'FOODCONCEPT_TERMINAL_OWNER_FEE_RECEIVABLE(Debit_Nr)'
                          ...
                          WHEN (RIGHT(DebitAccNr.acc_nr,12) = 'POOL_ACCOUNT') THEN 'POOL ACCOUNT(Debit_Nr)'
                          ...
                          WHEN (RIGHT(DebitAccNr.acc_nr,12) ='FEE_POOL') THEN 'FEE POOL(Debit_Nr)'  
                          WHEN (RIGHT(DebitAccNr.acc_nr,16) = 'EASYFUEL_ACCOUNT') THEN 'EASYFUEL ACCOUNT(Debit_Nr)'
                          ...
                          WHEN (RIGHT(DebitAccNr.acc_nr,18) = 'SVA_FEE_RECEIVABLE') THEN 'SVA FEE RECEIVABLE(Debit_Nr)'
                          WHEN (RIGHT(DebitAccNr.acc_nr,22) = 'UDIRECT_FEE_RECEIVABLE') THEN 'UDIRECT FEE RECEIVABLE(Debit_Nr)'
                          WHEN (RIGHT(DebitAccNr.acc_nr,19) ='PTSP_FEE_RECEIVABLE') THEN 'PTSP FEE RECEIVABLE(Debit_Nr)'
                            
                          WHEN (RIGHT(DebitAccNr.acc_nr,18) = 'NCS_FEE_RECEIVABLE') THEN 'NCS FEE RECEIVABLE(Debit_Nr)'  
			  WHEN (RIGHT(DebitAccNr.acc_nr,23) = 'SVA_SPONSOR_FEE_PAYABLE') THEN 'SVA SPONSOR FEE PAYABLE(Debit_Nr)'
			  WHEN (RIGHT(DebitAccNr.acc_nr,26) =  'SVA_SPONSOR_FEE_RECEIVABLE') THEN 'SVA SPONSOR FEE RECEIVABLE(Debit_Nr)'                      
  ...
  Credit_account_type=CASE  
                     ...
                     and (dbo.fn_rpt_isBillpayment (PTC.terminal_id,PT.extended_tran_type,PT.message_type,PT.sink_node_name,PT.payee,ptc.card_acceptor_id_code ,ptc.source_node_name,pt.tran_type,ptc.pan) = 0)
                      ...
                      AND dbo.fn_rpt_CardGroup(ptc.pan) = '6' THEN 'VISA CO-ACQUIRER FEE PAYABLE(Credit_Nr)' */
                        ...
                        WHEN (CreditAccNr.acc_nr LIKE '%AMOUNT%PAYABLE') THEN 'AMOUNT PAYABLE(Debit_Nr)'
  	                  WHEN (CreditAccNr.acc_nr LIKE '%AMOUNT%RECEIVABLE') THEN 'AMOUNT RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%RECHARGE%FEE%PAYABLE') THEN 'RECHARGE FEE PAYABLE(Debit_Nr)'  
                            WHEN (CreditAccNr.acc_nr LIKE '%ACQUIRER%FEE%PAYABLE') THEN 'ACQUIRER FEE PAYABLE(Debit_Nr)' 
                            WHEN (CreditAccNr.acc_nr LIKE '%CO%ACQUIRER%FEE%RECEIVABLE') THEN 'CO-ACQUIRER FEE RECEIVABLE(Debit_Nr)'   
                            WHEN (CreditAccNr.acc_nr LIKE '%ACQUIRER%FEE%RECEIVABLE') THEN 'ACQUIRER FEE RECEIVABLE(Debit_Nr)'  
                            WHEN (CreditAccNr.acc_nr LIKE '%ISSUER%FEE%PAYABLE') THEN 'ISSUER FEE PAYABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%CARDHOLDER%ISSUER%FEE%RECEIVABLE%') THEN 'CARDHOLDER_ISSUER FEE RECEIVABLE(Debit_Nr)' 
                            WHEN (CreditAccNr.acc_nr LIKE '%SCH%ISSUER%FEE%RECEIVABLE') THEN 'SCHEME OWNER ISSUER FEE RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%ISSUER%FEE%RECEIVABLE') THEN 'ISSUER FEE RECEIVABLE(Debit_Nr)'
                            WHEN ( RIGHT(CreditAccNr.acc_nr,32) = 'PAYIN_INSTITUTION_FEE_RECEIVABLE') THEN 'PAYIN INSTITUTION FEE RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%ISW%FEE%PAYABLE') THEN 'ISW FEE PAYABLE(Debit_Nr)'
                            WHEN ( CHARINDEX('ISW_ATM_FEE_CARD_SCHEME',CreditAccNr.acc_nr)>0) THEN 'ISW CARD SCHEME FEE RECEIVABLE (Debit_Nr)'
                            WHEN ( CHARINDEX( 'ISW_ATM_FEE_ACQ_', CreditAccNr.acc_nr) > 0 ) THEN 'ISW ACQUIRER FEE RECEIVABLE (Debit_Nr)'
                            WHEN ( CHARINDEX( 'ISW_ATM_FEE_ISS_',CreditAccNr.acc_nr)>0  ) THEN 'ISW ISSUER FEE RECEIVABLE (Debit_Nr)'
                            ...
                            AND dbo.fn_rpt_CardType (PTC.PAN ,PT.SINK_NODE_NAME ,PT.TRAN_TYPE,PTC.TERMINAL_ID)= '9'
                            AND NOT ((CreditAccNr.acc_nr LIKE '%ISO%FEE%RECEIVABLE') OR (CreditAccNr.acc_nr LIKE '%PTSP_FEE_RECEIVABLE')OR (CreditAccNr.acc_nr LIKE '%TERMINAL%FEE%RECEIVABLE') OR (CreditAccNr.acc_nr LIKE '%PROCESSOR%FEE%RECEIVABLE') OR (CreditAccNr.acc_nr LIKE '%NCS%FEE%RECEIVABLE'))) THEN 'ISW FEE RECEIVABLE(Debit_Nr)'
                            WHEN ( LEFT(CreditAccNr.acc_nr,15) = 'POS_FOODCONCEPT')THEN 'FOODCONCEPT_TERMINAL_OWNER_FEE_RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%ISO%FEE%RECEIVABLE') THEN 'ISO FEE RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%TERMINAL_OWNER%FEE%RECEIVABLE') THEN 'TERMINAL_OWNER FEE RECEIVABLE(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%PROCESSOR%FEE%RECEIVABLE') THEN 'PROCESSOR FEE RECEIVABLE(Debit_Nr)'
                            WHEN (RIGHT(CreditAccNr.acc_nr,12) = 'POOL_ACCOUNT') THEN 'POOL ACCOUNT(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%ATMC%FEE%PAYABLE') THEN 'ATMC FEE PAYABLE(Debit_Nr)'  
                            WHEN (CreditAccNr.acc_nr LIKE '%ATMC%FEE%RECEIVABLE') THEN 'ATMC FEE RECEIVABLE(Debit_Nr)'  
                            WHEN (RIGHT(CreditAccNr.acc_nr,12) ='FEE_POOL') THEN 'FEE POOL(Debit_Nr)'  
                            WHEN (RIGHT(CreditAccNr.acc_nr,16) = 'EASYFUEL_ACCOUNT') THEN 'EASYFUEL ACCOUNT(Debit_Nr)'
                            WHEN (CreditAccNr.acc_nr LIKE '%MERCHANT%FEE%RECEIVABLE') THEN 'MERCHANT FEE RECEIVABLE(Debit_Nr)' 
                            WHEN (CreditAccNr.acc_nr LIKE '%YPM%FEE%RECEIVABLE') THEN 'YPM FEE RECEIVABLE(Debit_Nr)' 
                            WHEN (CreditAccNr.acc_nr LIKE '%FLEETTECH%FEE%RECEIVABLE') THEN 'FLEETTECH FEE RECEIVABLE(Debit_Nr)' 
                            WHEN (CreditAccNr.acc_nr LIKE '%LYSA%FEE%RECEIVABLE') THEN 'LYSA FEE RECEIVABLE(Debit_Nr)'
  
                           
                            WHEN (RIGHT(CreditAccNr.acc_nr,18) = 'SVA_FEE_RECEIVABLE') THEN 'SVA FEE RECEIVABLE(Debit_Nr)'
                            WHEN (RIGHT(CreditAccNr.acc_nr,22) = 'UDIRECT_FEE_RECEIVABLE') THEN 'UDIRECT FEE RECEIVABLE(Debit_Nr)'
                            WHEN (RIGHT(CreditAccNr.acc_nr,19) ='PTSP_FEE_RECEIVABLE') THEN 'PTSP FEE RECEIVABLE(Debit_Nr)'
                              
                            WHEN (RIGHT(CreditAccNr.acc_nr,18) = 'NCS_FEE_RECEIVABLE') THEN 'NCS FEE RECEIVABLE(Debit_Nr)'  
  			  WHEN (RIGHT(CreditAccNr.acc_nr,23) = 'SVA_SPONSOR_FEE_PAYABLE') THEN 'SVA SPONSOR FEE PAYABLE(Debit_Nr)'
			  WHEN (RIGHT(CreditAccNr.acc_nr,26) =  'SVA_SPONSOR_FEE_RECEIVABLE') THEN 'SVA SPONSOR FEE RECEIVABLE(Debit_Nr)'   
...
END,
	...
	business_date=j.business_date,
        currency = CASE WHEN (dbo.fn_rpt_isBillpayment (PTC.terminal_id,PT.extended_tran_type,PT.message_type,PT.sink_node_name,PT.payee,ptc.card_acceptor_id_code ,ptc.source_node_name,pt.tran_type,ptc.pan) = '1' and 
                           (CHARINDEX('BILLPAYMENT MCARD',DebitAccNr.acc_nr)>0 or CHARINDEX('BILLPAYMENT MCARD',CreditAccNr.acc_nr)>0  ) ) THEN '840'
...
WHERE 
       (J.recon_business_date >= @from_date AND J.recon_business_date < (@to_date))
	   AND
	 PTC.post_tran_cust_id >= @rpt_tran_id
			AND
      ...
      and ( CHARINDEX('TPP',ptc.source_node_name)<1)
