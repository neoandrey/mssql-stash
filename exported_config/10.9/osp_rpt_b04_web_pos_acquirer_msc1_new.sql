if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[osp_rpt_b04_web_pos_acquirer_msc1]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[osp_rpt_b04_web_pos_acquirer_msc1]
GO
...
CREATE                                                   PROCEDURE osp_rpt_b04_web_pos_acquirer_msc1
...
*/
	...
	INSERT INTO  @list_of_IINs  SELECT part FRPM @IINs
	...
	WHERE 			
				...
				AND 
				(t.recon_business_date <= @report_date_end) -- changed from recon_business_date
				AND
