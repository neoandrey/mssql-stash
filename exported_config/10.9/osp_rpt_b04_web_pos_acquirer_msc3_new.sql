if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[osp_rpt_b04_web_pos_acquirer_msc3]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[osp_rpt_b04_web_pos_acquirer_msc3]
GO
...
CREATE                                                       PROCEDURE [dbo].[osp_rpt_b04_web_pos_acquirer_msc3]
