...
CREATE                                                                  PROCEDURE [dbo].[osp_rpt_b04_web_acquirer_bkp]
...
CREATE PROCEDURE [dbo].[osp_rpt_b04_payment_gateway_bkp]
...
create PROCEDURE [dbo].[osp_rpt_cashcard_load_bkp]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate	VARCHAR(30),	-- yyyymmdd
	@SinkNode		VARCHAR(40),
	@CBNCodes		VARCHAR(40),
...
CREATE                         PROCEDURE [dbo].[psp_settlement_summary_breakdown_reward](
...
CREATE        PROCEDURE [dbo].[psp_rpt_settlement_reconciliation]
...
CREATE PROCEDURE [dbo].[osp_rpt_CashAdvance_VAS]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	---@SinkNode		VARCHAR(40),
	@show_full_pan	BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_bill_payment_VAS]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	---@SinkNode		VARCHAR(40),
	@show_full_pan	BIT,
...
CREATE                              PROCEDURE [dbo].[osp_rpt_b08_MC_Processing_all]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate	VARCHAR(30),	-- yyyymmdd
...
CREATE PROCEDURE [dbo].[osp_rpt_b08_MC_Processing]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate	VARCHAR(30),	-- yyyymmdd
	@SinkNode		VARCHAR(40),
	@SourceNodes		VARCHAR(255),
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_Verve_Int_settlement_bank]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate	VARCHAR(30),	-- yyyymmdd
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_Verve_Int]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate	VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@AcquirerBin     	VARCHAR(40),
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_SwitchedIn]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_SmartpointElohoTest]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_Smartpoint]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	--@SourceNode		VARCHAR(40),
	--@terminalID		VARCHAR(40),	
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_MOI]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@terminalID		VARCHAR(40),	
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_atmc]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_verve_int]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Smartpoint]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_NOU_Smartpoint]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_NOU_cardless]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_GTB_On_Us]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Discover]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Detailed_verve_int]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Detailed_Discover]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Cardless]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all_Acquirer_verve_int]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b06_all]--oremeyi modified the previous
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SourceNode		VARCHAR(40),
	@show_full_pan	 BIT,
...
CREATE PROCEDURE [dbo].[osp_rpt_b04_WebAcquirer]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	--@Acquirer		VARCHAR(255),
	---@AcquirerInstId		VARCHAR(255),
...
CREATE                                                                 PROCEDURE [dbo].[osp_rpt_b04_WEB_VISA_COACQUIRED]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@Acquirer		VARCHAR(255),
	@AcquirerInstId		VARCHAR(255),
...
CREATE PROCEDURE [dbo].[osp_rpt_b04_web_summary]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SinkNode		VARCHAR(255),
	@SourceNodes	VARCHAR(255),
...
CREATE                                                                             PROCEDURE [dbo].[osp_rpt_b04_web_remote]
...
CREATE PROCEDURE [dbo].[osp_rpt_b04_web_rdm_ISW]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
...
CREATE PROCEDURE [dbo].[osp_rpt_b04_Web_Purchase_all_DS]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@SinkNode		VARCHAR(255),
	@SourceNodes	VARCHAR(255),
...
CREATE                     PROCEDURE [dbo].[osp_rpt_b04_web_pos_Visa_Co_acquirer_new]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@Acquirer		VARCHAR(255),
	@AcquirerInstId		VARCHAR(255),
...
CREATE                     PROCEDURE [dbo].[osp_rpt_b04_web_pos_Co_acquirer]
	@StartDate		VARCHAR(30),	-- yyyymmdd
	@EndDate		VARCHAR(30),	-- yyyymmdd
	@Acquirer		VARCHAR(255),
	@AcquirerInstId		VARCHAR(255),
