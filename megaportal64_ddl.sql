...
insert into  [ReportServer].[dbo].[administrative_users]  values ('officeadmin', 'CoreTech',0);
DECLARE @host_name VARCHAR(70);
SET @host_name = @@SERVERNAME+'\Administrator';
insert into  [ReportServer].[dbo].[administrative_users]  values (@host_name, 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('sa', 'SQL',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Chris.Esumeh', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Princess.Edoosagie', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Olasupo.Ogunsanya', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Damilola.Akinshiku', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Josiah.Adenegan', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Oladimeji.Isola', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Adetokunbo.Ige', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Gbolahan.Olowokandi', 'CoreTech',0)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Mobolaji.Aina', 'CoreTech',0)
	insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Ebun.Reffell', 'Settlement',1)
insert into  [ReportServer].[dbo].[administrative_users]  values ('INTERSWITCH\Owolabi.Akala', 'TPPOPS',1)
...
select s.name,l.name
 ...
 select  CONVERT(VARCHAR(MAX),login_name collate SQL_Latin1_General_CP1_CI_AS )   from [ReportServer].dbo.[administrative_users] 
 )
