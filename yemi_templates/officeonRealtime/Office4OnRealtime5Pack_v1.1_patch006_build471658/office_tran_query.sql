	...
	SET @report_date_start = '2015-03-05'
	SET @report_date_end= '2015-03-06'
	EKWUEME JENNIFER NKE  EN           ENNG (2033EN000000447)
	...
	IF(@report_date_start<> @report_date_end) BEGIN
		SELECT TOP 1 @first_post_tran_id=post_tran_id, @first_post_tran_cust_id=post_tran_cust_id FROM post_tran WITH (NOLOCK, INDEX(ix_post_tran_9)) WHERE    recon_business_date = @report_date_start and datetime_req >= @report_date_start ORDER BY recon_business_date ASC
...
AND terminal_id = '3IPDFDT2'
AND system_trace_audit_nr ='055466'
AND pan= '628051*********6689'
