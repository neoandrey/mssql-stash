...
/****** Object:  Table [dbo].[joined_transaction_table]    Script Date: 05/20/2014 13:50:39 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[joined_transaction_table](
	...
	CONSTRAINT pk_joined_trans_table PRIMARY KEY ([post_tran_id]),
	CONSTRAINT online_system_constraint UNIQUE ( post_tran_id, online_system_id)
...
ALTER TABLE [dbo].[joined_transaction_table] ADD  CONSTRAINT [DF__transacti__next___173876EA]  DEFAULT ((0)) FOR [next_post_tran_id]
GO

ALTER TABLE [dbo].[joined_transaction_table] ADD  CONSTRAINT [DF__transacti__tran___182C9B23]  DEFAULT ((0)) FOR [tran_reversed]
GO

ALTER TABLE [dbo].[joined_transaction_table] ADD  CONSTRAINT [DF__transacti__draft__1920BF5C]  DEFAULT ((0)) FOR [draft_capture]
GO
