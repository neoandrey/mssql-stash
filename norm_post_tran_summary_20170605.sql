...
GO
/****** Object:  StoredProcedure [dbo].[norm_post_tran_summary]    Script Date: 6/5/2017 8:34:54 AM ******/
SET ANSI_NULLS ON
GO
			...
			begin
				...
				as
					SELECT  a.[post_tran_id]
						  ...
						  ,(SELECT  structured_data_req FROM post_tran (NOLOCK, index=ix_post_tran_1) WHERE post_tran_id  = a.post_tran_id) structured_data_req
						  ,a.[tran_reversed]
		...
		begin
			...
			begin
				...
				' 
					...
					CREATE NONCLUSTERED INDEX [ix_post_tran_summary_'+@table_date+'_20] ON [dbo].[post_tran_summary_'+@table_date+'] 
					(
	[recon_business_date] ASC,
	[tran_completed] ASC,
	[tran_postilion_originated] ASC,
...
INCLUDE ( [post_tran_cust_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
