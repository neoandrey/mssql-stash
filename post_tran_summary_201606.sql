...
CREATE TABLE [dbo].[post_tran_summary_201606](
...
ALTER TABLE [dbo].[post_tran_summary_201606] ADD  DEFAULT ((0)) FOR [next_post_tran_id]
GO

ALTER TABLE [dbo].[post_tran_summary_201606] ADD  DEFAULT ((0)) FOR [tran_reversed]
GO
ALTER TABLE [dbo].[post_tran_summary_201606] ADD  DEFAULT ((0)) FOR [draft_capture]
GO
