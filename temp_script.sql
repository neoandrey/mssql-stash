...
SELECT DATEADD(hour,DATEDIFF(hour,0,datetime_tran_gmt),0),
a.[post_tran_id]
      ,a.[post_tran_cust_id]
      ,[settle_entity_id]
      ,[batch_nr]
 ...
 FROM dbo.post_tran a (nolock) JOIN dbo.post_tran_cust b (nolock)
         	                   ON a.post_tran_cust_id = b.post_tran_cust_id
WHERE datetime_tran_gmt between @startTime and @endTime
--GROUP BY DATEADD(hour,DATEDIFF(hour,0,datetime_tran_gmt),0),
