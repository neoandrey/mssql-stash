CREATE PROCEDURE usp_send_normalization_status_mail
...
EXEC msdb.dbo.sp_send_dbmail @recipients='normalization@interswitch.pagerduty.com',
@subject = @subject,
@body = @tableHTML,
@body_format = 'HTML',
@copy_recipients='mobolaiji.aina@interswitchgroup.com,gbolahan.olowokandi@interswitchgroup.com',
