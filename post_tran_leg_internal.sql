...
/****** Object:  Table [dbo].[post_tran_leg_internal]    Script Date: 12/6/2016 8:27:42 AM ******/
SET ANSI_NULLS ON
GO
...
) ON [PRIMARY] TEXTIMAGE_ON [XML_DATA]
SET ANSI_PADDING ON
ALTER TABLE [dbo].[post_tran_leg_internal] ADD [secure_3d_result] [varchar](50) NULL
ALTER TABLE [dbo].[post_tran_leg_internal] ADD [pos_data] [varchar](50) NULL
ALTER TABLE [dbo].[post_tran_leg_internal] ADD [card_acceptor_phone_nr] [varchar](50) NULL
