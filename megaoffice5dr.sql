...
UPDATE [administrative_users] SET is_monitored = 1 WHERE login_name='INTERSWITCH\Owolabi.Akala'
GO
...
tr:nth-child(even)	{ background-color:#fff; }	
          ...
          IF(SUSER_SNAME() LIKE '%EBUN%' OR SUSER_SNAME() LIKE '%OWOLABI%')BEGIN
				   EXEC msdb.dbo.sp_send_dbmail @profile_name = 'Office Vigilante Profile',
