...
GO
/****** Object:  StoredProcedure [dbo].[usp_copy_settlement_transaction_details_20170322]    Script Date: 03/23/2017 23:05:19 ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 ALTER PROCEDURE [dbo].[usp_copy_settlement_transaction_details_20170322] (@settlement_date NVARCHAR(10), @retention_period INT)  AS
							BEGIN
							...
							EXEC ('SELECT  MAX(post_tran_id) post_tran_id INTO  ##temp_query_table  FROM  [postilion_office].[dbo].['+@table_name+'] (NOLOCK)')
							...
							IF (@start_post_tran_id = 0 OR @start_post_tran_id IS NULL)
							 BEGIN
									...
									EXEC ('SELECT  MAX(post_tran_id) post_tran_id INTO  ##temp_query_table  FROM  [postilion_office].[dbo].['+@previous_table_name+'] (NOLOCK)')
									IF(OBJECT_ID('tempdb.dbo.##temp_query_table') IS NOT NULL) BEGIN
										SELECT @start_post_tran_id = ISNULL(post_tran_id,0)  FROM  ##temp_query_table;
										DROP TABLE ##temp_query_table;
									END
									...
									BEGIN      			
								print @start_post_tran_id	
							EXEC ('SELECT MIN (last_post_tran_id) post_tran_id INTO  ##temp_query_table  FROM postilion_office.dbo.sstl_session (NOLOCK) WHERE CONVERT(VARCHAR(10),datetime_started ,112)='''+@settlement_date+''' and completed =1 ')
							IF(OBJECT_ID('tempdb.dbo.##temp_query_table') IS NOT NULL) BEGIN
							...
							END
														...
														EXEC('IF (OBJECT_ID(''tempdb.dbo.##settle_tran_details'') IS NOT NULL) BEGIN
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_1] ON [##temp_post_tran_data_local] 
(
	[PT_message_type] ASC
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_10] ON [##temp_post_tran_data_local] 
(
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_11] ON [##temp_post_tran_data_local] 
(
	[PT_message_type] ASC,
	[PT_tran_type] ASC,
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_12] ON [##temp_post_tran_data_local] 
(
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_13] ON [##temp_post_tran_data_local] 
(
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_14] ON [##temp_post_tran_data_local] 
(
	[PT_tran_postilion_originated] ASC,
	[PTC_totals_group] ASC
)
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_15] ON [##temp_post_tran_data_local] 
(
	[PT_recon_business_date] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_16] ON [##temp_post_tran_data_local] 
(
	[PT_tran_postilion_originated] ASC,
	[PT_message_type] ASC,
	[PT_rsp_code_rsp] ASC,
...
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_17] ON [##temp_post_tran_data_local] 
(
	[PT_extended_tran_type] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_18]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_18] ON [##temp_post_tran_data_local] 
(
	[PT_retention_data] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_2]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_2] ON [##temp_post_tran_data_local] 
(
	[PT_tran_type] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_3]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_3] ON [##temp_post_tran_data_local] 
(
	[PTC_source_node_name] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_4]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_4] ON [##temp_post_tran_data_local] 
(
	[PT_sink_node_name] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_5]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_5] ON [##temp_post_tran_data_local] 
(
	[PTC_terminal_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_6]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_6] ON [##temp_post_tran_data_local] 
(
	[PTC_totals_group] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_7]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_7] ON [##temp_post_tran_data_local] 
(
	[PTC_pan] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_9]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_9] ON [##temp_post_tran_data_local] 
(
	[PT_acquiring_inst_id_code] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 95) ON [PRIMARY]


/****** Object:  INDEX [ix_temp_journal_data_local_local_recon]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_recon] ON [##temp_post_tran_data_local] 
(
	[PT_tran_postilion_originated] ASC,
...
/****** Object:  INDEX [ix_temp_journal_data_local_local_recon_2]    Script Date: 03/16/2017 22:16:06 ******/
CREATE NONCLUSTERED INDEX [ix_temp_journal_data_local_local_recon_2] ON [##temp_post_tran_data_local] 
(
	[PT_tran_postilion_originated] ASC,
	[PT_settle_currency_code] ASC,
	[PT_sink_node_name] ASC,
...
EXEC('	DECLARE @all_fees VARCHAR(255)
...
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1046'' and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''UBN''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9130'',''8130'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''ABS''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9044'',''8044'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''ABP''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9023'',''8023'')  and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) then ''CITI''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9050'',''8050'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''EBN''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9214'',''8214'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''FCMB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9070'',''8070'',''1100'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''FBP''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9011'',''8011'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''FBN''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9058'',''8058'')  and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) then ''GTB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9082'',''8082'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''KSB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9076'',''8076'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''SKYE''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9084'',''8084'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''ENT''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9039'',''8039'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''IBTC''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9068'',''8068'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''SCB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9232'',''8232'',''1105'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''SBP''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9032'',''8032'')  and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) then ''UBN''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9033'',''8033'')  and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) then ''UBA''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9215'',''8215'')  and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) then ''UBP''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9035'',''8035'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''WEMA''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9057'',''8057'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''ZIB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9301'',''8301'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''JBP''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''9030'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)  then ''HBC''	  
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1411'' and 
		(CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''HBC''																						  
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1131'' and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''WEMA''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''1061'',''1006'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''GTB''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1708'' and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0)THEN ''FBN''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)  IN (''1027'',''1045'',''1081'',''1015'') and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''SKYE''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1037'' and 
		(CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''IBTC''
WHEN (SELECT TOP 1 PT_retention_data FROM ##temp_post_tran_data_local PTT (NOLOCK) WHERE PT_tran_postilion_originated  =1 AND PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr)   = ''1034'' and 
		 (CHARINDEX(DebitAccNr_acc_nr, @all_fees)> 0 OR CHARINDEX(CreditAccNr_acc_nr, @all_fees)> 0) THEN ''EBN''
														...
														END,
														 ...
														 FROM (  SELECT  PT.PT_post_tran_id
														 ...
														 (select  [adj_id]
															  ...
															  ,[coa_config_state] from  ##temp_journal_data_local (NOLOCK) )  J 
																		 ...
																		 (SELECT * FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =0)   PT 
																			ON (J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id and substring(pt.ptc_terminal_id,1,1)!=''G'')
														  ...
														  OPTION (MAXDOP 8)')
															...
															EXEC('IF (OBJECT_ID(''tempdb.dbo.#temp_table'') is not null )begin
...
SELECT DISTINCT report_results.bank_code,
			 ...
			 ,(SELECT  TOP  1   [PT_batch_nr]  FROM   ##temp_post_tran_data_local PT  (nolock, INDEX(ix_post_tran_id)) WHERE  PT.PT_post_tran_id = report_results.PTID )S			PT_batch_nrS
			 ...
			 INTO ##final_results_tables  
			   FROM 
			 						     ##settle_tran_details report_results  (nolock) join ##temp_post_tran_data_local PTT (nolock)  ON   PT.PT_post_tran_id = report_results.PTID
			 						OPTION(RECOMPILE, MAXDOP 8)
			 								
							INSERT INTO ['+@previous_table_name+']	SELECT * ,post_tran_id_1,post_tran_cust_id_1 FROM ##final_results_tables;								 
															 ');
	...
	EXEC('IF (OBJECT_ID(''tempdb.dbo.##settle_tran_details'') IS NOT NULL) BEGIN
		...
		END
				...
				IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[settlement_summary_breakdown_details]')) BEGIN
					...
					END
						EXEC('	DECLARE @temp_post_tran_id BIGINT							
				...
				EXEC ('SELECT MAX (last_post_tran_id) post_tran_id INTO  ##temp_query_table  FROM postilion_office.dbo.sstl_session (NOLOCK) WHERE CONVERT(VARCHAR(10),datetime_started ,112)='''+@settlement_date+''' and completed =1 ')
							IF(OBJECT_ID('tempdb.dbo.##temp_query_table') IS NOT NULL) BEGIN
								SELECT @end_post_tran_id = ISNULL(post_tran_id,0)  FROM  ##temp_query_table;
								DROP TABLE ##temp_query_table;
							END			    
														 ...
														 (select  [adj_id]
															  ...
															  ,[coa_config_state] from  ##temp_journal_data_local (NOLOCK) )  J 
																		 ...
																		 (SELECT * FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =0)   PT 
																			ON (J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id and substring(pt.ptc_terminal_id,1,1)!=''G'')
																		 JOIN 
																		 (SELECT * FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =1)PTT on (PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr) 
														and 
															(
																  (PT.PT_settle_amount_impact<> 0 and PT.PT_message_type   in (''0200'',''0220''))
															   or ((PT.PT_settle_amount_impact<> 0 and PT.PT_message_type = ''0420'' 
...
PT_post_tran_id
			 ...
			 INTO ##final_results_tables  
			   FROM 
				...
				INSERT INTO ['+@table_name+'] SELECT *,post_tran_id_1,post_tran_cust_id_1 FROM  ##final_results_tables;											 
