...
GO
/****** Object:  StoredProcedure [dbo].[norm_post_tran_summary]    Script Date: 08/29/2016 21:31:59 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	BEGIN
		...
		if( datediff(MINUTE, CONVERT(varchar(8),getdate(),112), getdate())>30  AND CAST((CONVERT(varchar(8),getdate(),112)) as int) > cast (@table_date as int))-- today > last table date & cant copy any more data
		begin
			print 'Its next day...'
			...
			begin
				...
				' 
					...
					[card_acceptor_id_code],
					[card_acceptor_name_loc],
					[pan_encrypted]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = OFF, ALLOW_PAGE_LOCKS  = OFF) ON [PRIMARY]
					...
					CREATE NONCLUSTERED INDEX [ix_post_tran_'+@table_date+'_summary_tpp_1] ON [dbo].[post_tran_summary_'+@table_date+'] 
					(
						[tran_completed],[message_type] ASC
					)INCLUDE ([post_tran_id],[sink_node_name],[tran_type],[rsp_code_rsp],[datetime_req],[tran_amount_req],[card_acceptor_name_loc],[pan])

					WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = OFF, ALLOW_PAGE_LOCKS  = OFF) ON [PRIMARY]
					

/****** Object:  Index [indx_message_type]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_message_type] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[message_type] ASC
)
INCLUDE ( [post_tran_cust_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [PRIMARY]


/****** Object:  Index [indx_post_tran_cust_id]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_post_tran_cust_id] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[post_tran_cust_id] ASC
)
INCLUDE ( [tran_amount_req]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [PRIMARY]


/****** Object:  Index [indx_post_tran_cust_id_tran_postilion_originated_message_type]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [ix_post_tran_cust_id_tran_postilion_originated_message_type] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[post_tran_cust_id] ASC,
	[tran_postilion_originated] ASC,
	[message_type] ASC
...
[card_acceptor_id_code],
[card_acceptor_name_loc],
[pan_encrypted]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [PRIMARY]


/****** Object:  Index [indx_recon_business_date]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_recon_business_date] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[recon_business_date] ASC
...
/****** Object:  Index [indx_sink_node_name_message_type_rsp_code_reqabort_rsp_code_recon_business_date_tran_amount_req]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_sink_node_name_message_type_rsp_code_reqabort_rsp_code_recon_business_date_tran_amount_req] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[sink_node_name] ASC,
	[message_type] ASC,
	[rsp_code_req] ASC,
...
INCLUDE ( [post_tran_cust_id],
[tran_nr]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [PRIMARY]


/****** Object:  Index [indx_tran_completed_recon_business_date_tran_currency_code_tran_reversed]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_completed_recon_business_date_tran_currency_code_tran_reversed] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_completed] ASC,
	[recon_business_date] ASC,
...
[card_acceptor_id_code],
[merchant_type],
[card_acceptor_name_loc]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 70) ON [PRIMARY]


/****** Object:  Index [indx_tran_post_10]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_post_10] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[message_type] ASC
)
...
/****** Object:  Index [indx_tran_postilion_originated_tran_completed_recon_business_date_tran_currency_code]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postilion_originated_tran_completed_recon_business_date_tran_currency_code] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[recon_business_date] ASC,
...
/****** Object:  Index [indx_tran_postilion_originated_tran_completed_recon_business_date_tran_currency_code_tran_reversedmessage_type_tran_amount_rsp]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postilion_originated_tran_completed_recon_business_date_tran_currency_code_tran_reversedmessage_type_tran_amount_rsp] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[recon_business_date] ASC,
...
/****** Object:  Index [indx_tran_postilion_originated_tran_completed_recon_business_datesettle_currency_code]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postilion_originated_tran_completed_recon_business_datesettle_currency_code] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[recon_business_date] ASC,
...
/****** Object:  Index [indx_tran_postilion_originated_tran_completed_tran_type_settle_currency_codemessage_type_source_node_name_pan_totals_group]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postilion_originated_tran_completed_tran_type_settle_currency_codemessage_type_source_node_name_pan_totals_group] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[tran_type] ASC,
...
/****** Object:  Index [indx_tran_postmessage_t_11]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postmessage_t_11] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[message_type] ASC,
...
/****** Object:  Index [indx_tran_postmessage_t_14]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postmessage_t_14] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[recon_business_date] ASC,
...
/****** Object:  Index [indx_tran_postmessage_t_15]    Script Date: 08/29/2016 21:30:26 ******/
CREATE NONCLUSTERED INDEX [indx_tran_postmessage_t_15] ON [dbo].[post_tran_summary_'+@table_date+'] 
(
	[tran_postilion_originated] ASC,
	[tran_completed] ASC,
	[message_type] ASC,
