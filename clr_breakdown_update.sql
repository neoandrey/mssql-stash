...
END,
	trxn_category=CASE WHEN (PT.PT_tran_type ='01')  
                          ...
                          and dbo.fn_rpt_settlement_breakdown_4 (DebitAccNr_acc_nr,CreditAccNr_acc_nr) = 1
                           ...
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)) THEN 'POS(TRAVEL AGENCIES)PURCHASE'
                           

                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '5'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1 )) THEN 'POS(HOTELS)PURCHASE'

                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '6'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)) THEN 'POS(WHOLESALE)PURCHASE'
                    
                            WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '14'
                            and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1
                            and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1 )) THEN 'POS(WHOLESALE_ACQUIRER_BORNE)PURCHASE'
                           ...
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1) ) THEN 'POS(TRAVEL AGENCIES-VISA)PURCHASE'
                     
                           WHEN (dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) ='2'
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)) THEN 'POS(WHOLESALE CLUBS-VISA)PURCHASE'
                           
                           WHEN (dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) ='3'
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)) THEN 'POS(GENERAL MERCHANT-VISA)PURCHASE'
                           
                           
                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '29'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan ) = 1
                            and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)) THEN 'POS(VAS CLOSED SCHEME)PURCHASE'+'_'+PT.PTC_merchant_type
                           ...
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1)
                           and SUBSTRING(PT.PTC_terminal_id,1,1) in ( '2','5','6') 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1 )THEN 'POS(GENERAL MERCHANT)PURCHASE' 
                           ...
                           and SUBSTRING(PT.PTC_terminal_id,1,1) in ( '2','5','6') 
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1)THEN 'POS PURCHASE WITH CASHBACK'
                           ...
                           and SUBSTRING(PT.PTC_terminal_id,1,1) in ( '2','5','6')
                           and not (fn_rpt_settlement_breakdown_5(DebitAccNr_acc_nr,CreditAccNr_acc_nr ) = 1) THEN 'POS CASHWITHDRAWAL'
...
END,
	...
	trxn_date=j.business_date,
        ...
        Unique_key = PT.PT_retrieval_reference_nr+'_'+PT.PT_system_trace_audit_nr+'_'+PT.PTC_terminal_id+'_'+ cast((CONVERT(NUMERIC (15,2),isnull(PT.PT_settle_amount_impact,0))) as )+'_'+PT.PT_message_type,
