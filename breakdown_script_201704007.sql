...
drop  table temp_journal_data_test
drop  table temp_post_tran_data_test
drop table test_settlement_breakdown_data

SELECT * into temp_journal_data_test FROM  [172.25.10.89].[postilion_office].dbo.temp_journal_data 
SELECT * into temp_post_tran_data_test FROM  [172.25.10.89].[postilion_office].dbo.temp_post_tran_data 
SELECT * INTO test_settlement_breakdown_data FROM  [172.25.10.89].[postilion_office].dbo.settlement_summary_breakdown WHERE trxn_date = '20170406'
...
trxn_category=CASE WHEN (PT.PT_tran_type ='01')  
			               ...
			               WHEN ( dbo.fn_rpt_isBillpayment (PT.PTC_terminal_id,PT.PT_extended_tran_type,PT.PT_message_type,PT.PT_sink_node_name,
			                   PT.PT_payee,PT.PTC_card_acceptor_id_code ,PT.PTC_source_node_name,PT.PT_tran_type,PT.PTC_pan) = '1')  then 'BILLPAYMENT'
                           ...
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(CHURCHES, FASTFOODS & NGOS)'

                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '3'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(CONCESSION)PURCHASE'

                           WHEN ( dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '4'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(TRAVEL AGENCIES)PURCHASE'
                           ...
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(WHOLESALE)PURCHASE'
                            ...
                            and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1
                            and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(WHOLESALE_ACQUIRER_BORNE)PURCHASE'


                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '7'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(FUEL STATION)PURCHASE'
 
                           WHEN (dbo.fn_rpt_MCC (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type)= '8'
                           and dbo.fn_rpt_MCC_Visa (PT.PTC_merchant_type,PT.PTC_terminal_id,PT.PT_tran_type,PT.PTC_PAN) is NULL
                           and dbo.fn_rpt_isPurchaseTrx_sett(PT.PT_tran_type,PT.PTC_source_node_name, PT.PT_sink_node_name,PT.PTC_terminal_id ,PT.PTC_totals_group ,PT.PTC_pan) = 1 
                           and not ([dbo].[fn_rpt_sttl_brkdwn_5](DebitAccNr_acc_nr,CreditAccNr_acc_nr) =1)) THEN 'POS(EASYFUEL)PURCHASE'
 ...
 trxn_amount=ISNULL(J.amount,0),
	...
	trxn_date=j.business_date,
      ...
      ,pt.[PTC_pan_reference]
													INTO settle_tran_details_tab_20170406
		...
		CREATE NONCLUSTERED INDEX [ix_settle_tran_details_tab_20170406_1]
ON [dbo].[settle_tran_details_tab_20170406] ([source_node_name])
INCLUDE ([Unique_key])
GO
...
USE [postilion_office]
GO
CREATE NONCLUSTERED INDEX [ix_settle_tran_details_tab_20170406_2]
ON [dbo].[settle_tran_details_tab_20170406] ([index_no])
...
USE [postilion_office]
GO
CREATE NONCLUSTERED INDEX [ix_settle_tran_details_tab_20170406_3]
ON [dbo].[settle_tran_details_tab_20170406] ([Unique_key],[source_node_name])
INCLUDE ([index_no])												  
...
,pan  pan
into final_settle_tran_details_tab_20170406
   FROM      settle_tran_details_tab_20170406  pt (nolock)  
