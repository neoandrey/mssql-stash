...
GO
/****** Object:  StoredProcedure [dbo].[osp_rpt_b06]    Script Date: 01/28/2015 08:34:58 ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON
	...
	WHERE 		
		...
		(
            ...
            ((c.source_node_name  in ('SWTASPATMsrc')) AND (substring (c.terminal_id,2,3) in (select substring(terminalID,2,3) from #list_of_terminalIds)
            ) 
)
