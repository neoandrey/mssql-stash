if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[usp_tempdb_manager]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[usp_tempdb_manager]
GO
   ...
   -- --                    LogError2:
			...
			WHILE (@@FETCH_STATUS =0)BEGIN
				...
				PRINT CHAR(10)+'Shrinking file : '+@fileName+'...'+CHAR(10)
				 exec ('USE [tempdb];  DBCC SHRINKFILE ('+@fileName+',0)');
				IF (@@ERROR=0) BEGIN 
