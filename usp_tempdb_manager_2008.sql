...
--exec sp_helpfile;	
ALTER PROCEDURE [dbo].[usp_tempdb_manager] (@growth_factor INT, @set_checkpoint BIT, @save_to VARCHAR (255),  @possible_growth_space BIGINT) AS 
	...
	IF  (@run_shrink=1) 
		BEGIN
		    ...
		    BEGIN TRY
				...
				BACKUP DATABASE tempdb TO DISK =@file_save_location
