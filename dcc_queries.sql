...
CREATE PROCEDURE get_dcc_transaction_transaction_report  (@report_date_start DATETIME,@report_date_end   DATETIME ) AS
BEGIN
	DECLARE 
	DECLARE 
	...
	SET @report_date_start = '2015-01-01'
	SET @report_date_end= '2015-04-13'
