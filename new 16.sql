...
GO
/****** Object:  StoredProcedure [dbo].[usp_copy_settlement_transaction_details]    Script Date: 03/22/2017 10:14:02 ******/
SET ANSI_NULLS ON
GO
														...
														,J.coa_config_state 
														 ...
														 (select  [adj_id]
															  ...
															  (SELECT * FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =0)   PT 
																  ...
																  and substring(pt.ptc_terminal_id,1,1)!=''G'')
																 JOIN 
														...
														,J.coa_config_state 
														 ...
														 (select  [adj_id]
															  ...
															  ,[coa_config_state] from  ##temp_journal_data_local (NOLOCK) )  J 
																		 ...
																		 JOIN 
																		  JOIN (SELECT  PT_post_tran_id,PT_post_tran_cust_id,ptc_terminal_id,PT_tran_nr, PT_retention_data FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =1)PTT 
																ON
																(PT.PT_post_tran_cust_id = PTT.PT_post_tran_cust_id and substring(ptT.ptc_terminal_id,1,1)!=''G'' and PT.PT_tran_nr = PTT.PT_tran_nr) 
