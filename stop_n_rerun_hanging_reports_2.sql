...
IF (OBJECT_ID('tempdb.dbo.#temp_process_run_2') IS NOT NULL)
   ...
   INSERT INTO  #temp_process_run   SELECT process_entity, spawned_name FROM post_process_queue WHERE process_name = 'Reports' AND queue_state=30 AND DATEDIFF(HOUR,@run_date,GETDATE())>=3
