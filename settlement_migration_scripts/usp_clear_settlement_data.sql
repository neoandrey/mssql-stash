create procedure usp_clear_settlement_data AS
...
DELETE FROM dbo.sstl_se
DELETE FROM dbo.spst_aggregation
DELETE FROM dbo.sstl_pred_prop_value
delete from dbo.sstl_acc
DELETE FROM dbo.sstl_proc_ent
delete from dbo.sstl_prop_value
delete from dbo.sstl_tran_field
delete from dbo.sstl_journal_fltr_grp
DELETE FROM dbo.spay_aggregation
delete from dbo.sstl_prop_value_node
DELETE FROM dbo.spst_proc_ent_fltr_grp
