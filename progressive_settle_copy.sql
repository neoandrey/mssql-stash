...
;WITH temp_journal_data_local  AS 
  (  SELECT  
	...
	WHERE post_tran_id  BETWEEN '+@start_post_tran_id+'  AND '+@last_post_tran_i+'
	...
	ON (PT.post_tran_cust_id = PTC.post_tran_cust_id and post_tran_id  BETWEEN '+@start_post_tran_id+'  AND '+@last_post_tran_id+'
	...
	AND PT.post_tran_id NOT IN (
			...
			WHERE ll.recon_business_date >= '+@start_post_tran_id+'
