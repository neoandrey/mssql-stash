...
GO
/****** Object:  StoredProcedure [dbo].[usp_get_settlement_data_for_period]    Script Date: 08/18/2016 12:13:33 ******/
SET ANSI_NULLS ON
GO
...
EXEC postilion_office.[dbo].[get_sstl_journal_daily];

;with  sstl_journal_daily_table as (	SELECT
				adj_id,
				entry_id,
				config_set_id,
				session_id,
	...
	FROM
	  sstl_journal_daily_table AS J (NOLOCK)
