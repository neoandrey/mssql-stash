		...
		SELECT * INTO test_settlement_breakdown_data FROM  [172.25.10.89].[postilion_office].dbo.settlement_summary_breakdown WHERE trxn_date = '20170411'
		...
		USE [postilion_office]
		GO
		CREATE NONCLUSTERED INDEX [ix_settle_tran_details_tab_20170406_5]
		ON [dbo].[settle_tran_details_tab_20170406] ([Unique_key],[source_node_name])
		INCLUDE ([index_no])
		*/
		...
		SELECT * FROM test_settlement_breakdown_data
