...
GO
/****** Object:  StoredProcedure [dbo].[usp_copy_settlement_transaction_details]    Script Date: 6/8/2017 6:20:52 AM ******/
SET ANSI_NULLS ON
GO
							...
							INTO  ##settle_tran_details 
								  ...
								  (SELECT  PT_post_tran_id,PT_post_tran_cust_id,ptc_terminal_id,PT_tran_nr, PT_retention_data FROM ##temp_post_tran_data_local (NOLOCK) WHERE PT_tran_postilion_originated =1)PTT 
														  ...
														  OPTION (RECOMPILE,optimize for unknown,maxdop 8)
														  								...
														  								DELETE FROM [##settle_tran_details] WHERE TRXN_CATEGORY  IN ( ''POS(CHURCHES, FASTFOODS & NGOS)'', ''POS(FUEL STATION)PURCHASE'',''POS(GENERAL MERCHANT)PURCHASE'',''POS(HOTELS)PURCHASE'')  AND
					(source_node_name   =''SWTNCS2src'' OR  PT_sink_node_name =  ''ASPPOSLMCsnk'')
