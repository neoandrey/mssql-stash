...
BEGIN
	...
	BEGIN
		...
		IF 
			(@last_sink_rsp_code_rsp IN('00','08','10','16','11'))
		BEGIN
		...
		IF (CHARINDEX('01', @last_sink_msg_type)<1) AND (CHARINDEX('02', @last_sink_msg_type)<1) AND (CHARINDEX('04', @last_sink_msg_type)<1)
		BEGIN
