...
VALUES        ('''+@interchange+'Clt'',''TCP Client'',60,'''+@interface+''')

INSERT   
INTO              nix_connections(nix_name, nix_type, misc_options, msg_profile)
VALUES        ('''+@interchange+'Svr'',''TCP Server'',44,'''+@interface+''')
'
...
'
	...
	INSERT      
	INTO              nix_connection_param_value(nix_name, nix_type, param_name, param_value)
	VALUES ('''+@interchange+ 'Svr'',''TCP Server'',''Remote Connection'',''1;SWTHOST;;SWTHOST'')

	INSERT      
	INTO              nix_connection_param_value(nix_name, nix_type, param_name, param_value)
	VALUES ('''+@interchange+ 'Svr'',''TCP Server'',''Remote Connection'',''2;AAPARTNER;;AAPARTNER'')';
...
begin	
		...
		BEGIN
				print 'INSERT INTO nix_connection_param_value
	...
	PRINT '
		INSERT INTO nix_connection_param_value
								 (nix_name, nix_type, param_name, param_value)
		VALUES       ('''+@interchange+ 'Clt'',''TCP Client'',''Remote Connection'',''2;AAPARTNER;;AAPARTNER,'+@port+''')
