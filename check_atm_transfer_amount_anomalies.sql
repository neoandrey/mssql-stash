...
GO
/****** Object:  StoredProcedure [dbo].[check_atm_transfer_amount_anomalies]    Script Date: 06/04/2014 08:19:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[check_atm_transfer_anomalies]  @start_date DATETIME, @end_date DATETIME
...
IF (DATEDIFF(D,@start_date,@end_date )>1) BEGIN
	...
	WHILE (@date_cursor <=@end_date) 
		...
		BEGIN
			...
			HAVING 
			SUM(settle_amount_impact)/100.0>=200000
			OR 
