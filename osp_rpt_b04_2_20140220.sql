...
GO
/****** Object:  StoredProcedure [dbo].[osp_rpt_b04_2]    Script Date: 02/21/2014 15:35:37 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	*/
	...
	FROM
				...
				(c.post_tran_cust_id >= @rpt_tran_id) AND  (t.recon_business_date >= CONVERT(DATETIME,@report_date_start) AND t.recon_business_date <= CONVERT(DATETIME,@report_date_end))
	WHERE 		
