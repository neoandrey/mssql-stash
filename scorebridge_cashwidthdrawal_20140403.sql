...
/****** Object:  Table [dbo].[scorebridge_cashwidthdrawal_20140327]    Script Date: 04/03/2014 18:26:38 ******/
SET ANSI_NULLS ON
GO
...
DROP TABLE [scorebridge_cashwidthdrawal_20140403]

CREATE TABLE [dbo].[scorebridge_cashwidthdrawal_20140403](
...
ALTER TABLE [dbo].[scorebridge_cashwidthdrawal_20140403] ADD  CONSTRAINT [DF__transaction__next___173876EA]  DEFAULT ((0)) FOR [next_post_tran_id]
GO

ALTER TABLE [dbo].[scorebridge_cashwidthdrawal_20140403] ADD  CONSTRAINT [DF__transaction__tran___182C9B23]  DEFAULT ((0)) FOR [tran_reversed]
GO

ALTER TABLE [dbo].[scorebridge_cashwidthdrawal_20140403] ADD  CONSTRAINT [DF__transaction__draft__1920BF5C]  DEFAULT ((0)) FOR [draft_capture]
GO
