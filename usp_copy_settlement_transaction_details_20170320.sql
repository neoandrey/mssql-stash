...
GO
/****** Object:  StoredProcedure [dbo].[usp_copy_settlement_transaction_details]    Script Date: 03/20/2017 17:08:15 ******/
SET ANSI_NULLS ON
GO
...
,(SELECT TOP  1 tag FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
        tag
...
,(SELECT TOP  1 adj_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
      adj_id
,(SELECT TOP  1 amount FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
     journal_amount
...
,(SELECT TOP  1 Amount_amount_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
    Amount_amount_id
...
,(SELECT TOP  1 Amount_config_set_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
     Amount_config_set_id
,(SELECT TOP  1 Amount_config_state FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
        Amount_config_state
,(SELECT TOP  1 Amount_description FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
            Amount_description
,(SELECT TOP  1 amount_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
             amount_id
,(SELECT TOP  1 Amount_name FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
                 Amount_name
,(SELECT TOP  1 Amount_se_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
                     Amount_se_id
,(SELECT TOP  1 amount_value_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
                     amount_value_id
...
,(SELECT TOP  1 business_date FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
      business_date
...
,(SELECT TOP  1 coa_coa_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
  coa_coa_id
,(SELECT TOP  1 coa_config_set_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
     coa_config_set_id
...
,(SELECT TOP  1 coa_config_set_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
coa_config_set_id
   ,        (SELECT TOP  1 Fee_config_set_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
Fee_config_set_id
,(SELECT TOP  1 Fee_config_state FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
 Fee_config_state
,(SELECT TOP  1 Fee_description FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
   Fee_description
...
,(SELECT TOP  1 nt_fee FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
           nt_fee
,(SELECT TOP  1 nt_fee_acc_post_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
               nt_fee_acc_post_id
,(SELECT TOP  1 nt_fee_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
                nt_fee_id
,(SELECT TOP  1 nt_fee_value_id FROM  ##temp_journal_data_local  J (NOLOCK) WHERE  J.post_tran_id = PT.PT_post_tran_id AND J.post_tran_cust_id = PT.PT_post_tran_cust_id)
                 nt_fee_value_id
...
,pt.pt_post_tran_id   
 INTO ##final_results_tables  
  FROM 
							 ...
							 JOIN  ##temp_post_tran_data_local PT  (nolock)
							on PT.PT_post_tran_id = report_results.PTID 
							   
							   
  
						      OPTION(RECOMPILE, MAXDOP 8)
							INSERT INTO ['+@previous_table_name+']	SELECT * FROM ##final_results_tables;								 
															 ');
...
INTO ##final_results_tables  
  FROM 
							...
							on PT.PT_post_tran_id = report_results.PTID 
															 ...
															 OPTION(RECOMPILE, MAXDOP 8)
				INSERT INTO ['+@table_name+'] SELECT * FROM  ##final_results_tables;											 
