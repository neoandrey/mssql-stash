...
BULK
  ...
  DECLARE tran_cursor CURSOR LOCAL FORWARD_ONLY STATIC READ_ONLY FOR SELECT DISTINCT pan, amount, stan, terminal_id, tran_code, message_type FROM #temp_tlv_table
  OPEN tran_cursor;
