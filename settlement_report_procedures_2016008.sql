...
JOIN (SELECT  [DATE] recon_business_date FROM  dbo.[get_dates_in_range]('20160504', '20160504'))rdate
...
CREATE NONCLUSTERED INDEX ix_temp_post_tran_data_8 ON temp_post_tran_data (PT_settle_amount_impact);
