CREATE PROCEDURE get_pos_rsp_code_analysis_on_demand @report_date_start DATETIME, @report_date_end DATETIME AS
...
BEGIN
	...
	SET @report_date_end   =  COALESCE(@report_date_start,    DATEADD(D, 1, REPLACE(CONVERT(VARCHAR(10), GETDATE(),111),'/', '-')))
