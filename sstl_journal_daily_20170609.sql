...
GO
/****** Object:  StoredProcedure [dbo].[usp_get_sstl_journal_daily]    Script Date: 6/9/2017 10:14:45 AM ******/
SET ANSI_NULLS ON
GO
...
DEALLOCATE sstl_cursor
	...
	EXEC ('CREATE VIEW sstl_journal_daily AS SELECT * FROM  sstl_journal_adj (nolock)  UNION ALL SELECT * FROM sstl_journal_daily_1 UNION ALL SELECT * FROM sstl_journal_daily_2  UNION ALL SELECT * FROM sstl_journal_daily_3  UNION ALL SELECT * FROM sstl_journal_daily_4  UNION ALL SELECT * FROM sstl_journal_daily_5 ')
	...
	ELSE IF(len(@sstl_sql_4)>1)BEGIN 
				...
				EXEC  (@sstl_sql_2 )
				 SET @sstl_sql_1 ='CREATE VIEW [dbo].[sstl_journal_daily_1] AS  '+SUBSTRING (LTRIM(RTRIM(@sstl_sql_1)), 1,  LEN(LTRIM(RTRIM(@sstl_sql_1))) -10);
				EXEC   ( @sstl_sql_1)
	EXEC ('CREATE VIEW sstl_journal_daily AS SELECT * FROM  sstl_journal_adj (nolock)  UNION ALL SELECT * FROM sstl_journal_daily_1  UNION ALL SELECT * FROM sstl_journal_daily_2  UNION ALL SELECT * FROM sstl_journal_daily_3  UNION ALL SELECT * FROM sstl_journal_daily_4')
	...
	ELSE IF(len(@sstl_sql_3)>1)begin
				...
				EXEC  (@sstl_sql_2 )
				 SET @sstl_sql_1 ='CREATE VIEW [dbo].[sstl_journal_daily_1] AS  '+SUBSTRING (LTRIM(RTRIM(@sstl_sql_1)), 1,  LEN(LTRIM(RTRIM(@sstl_sql_1))) -10);
				EXEC   ( @sstl_sql_1)
		EXEC ('CREATE VIEW sstl_journal_daily AS SELECT * FROM  sstl_journal_adj (nolock)  UNION ALL SELECT * FROM sstl_journal_daily_1  UNION ALL SELECT * FROM sstl_journal_daily_2  UNION ALL SELECT * FROM sstl_journal_daily_3')
	...
	ELSE IF(len(@sstl_sql_2)>1) BEGIN 
				...
				EXEC  (@sstl_sql_2 )
				 SET @sstl_sql_1 ='CREATE VIEW [dbo].[sstl_journal_daily_1] AS  '+SUBSTRING (LTRIM(RTRIM(@sstl_sql_1)), 1,  LEN(LTRIM(RTRIM(@sstl_sql_1))) -10);
				EXEC   ( @sstl_sql_1)
	EXEC ('CREATE VIEW sstl_journal_daily AS SELECT * FROM  sstl_journal_adj (nolock)  UNION ALL SELECT * FROM sstl_journal_daily_1  UNION ALL SELECT * FROM sstl_journal_daily_2')
	...
	END
				 ...
				 SET @sstl_sql_1 ='CREATE VIEW [dbo].[sstl_journal_daily_1] AS  '+SUBSTRING (LTRIM(RTRIM(@sstl_sql_1)), 1,  LEN(LTRIM(RTRIM(@sstl_sql_1))) -10);
				  EXEC   ( @sstl_sql_1)
	EXEC ('CREATE VIEW sstl_journal_daily AS SELECT * FROM  sstl_journal_adj (nolock)  UNION ALL SELECT * FROM sstl_journal_daily_1')
	END
