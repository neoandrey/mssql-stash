...
GO
/****** Object:  StoredProcedure [dbo].[usp_fetch_mega_office_breakdown_details]    Script Date: 06/28/2017 09:01:47 ******/
SET ANSI_NULLS ON
GO
...
SET @settle_date   = ISNULL(@settle_date, dateadd(d,-1, getdate()))

 SET @settle_date   =  replace(convert(varchar(11),@settle_date,121),'-','')
...
,0 Account_Name--Account_Name     Account_Name
